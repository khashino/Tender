...
class Command(BaseCommand):
    ...
    async def async_handle(self, *args, **options):
        ...
        try:
            ...
            worker = TenderReviewWorker(worker_id='task_completer')
            ...
            # Complete the task
            try:
                logger.info(f"Sending complete task request for job key: {task_id}")
                ...
                # Complete the task
                await worker.complete_task(task_id, variables)
